...
"""
df=pd.read_csv('mergedng.csv')
#print(df.iloc[:,15:23])
df.iloc[:,15:23] = df.iloc[:,15:23].replace({'yes': 1, 'no': 0})
print(df.iloc[:,15:23])
df.to_csv('mergedng-yn2binary.csv',encoding='utf-8',index=False)
"""
...
"""
df=pd.read_csv('mergedng-yn2binary.csv')
...
df.to_csv('mergedng-yn2binary-dummycoding.csv',encoding='utf-8',index=False)
"""
###################################################################
# correlation
"""
